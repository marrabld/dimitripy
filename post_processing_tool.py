...
class TimeSeriesIntercomparison():
    ...
    def plot_temporal_parameter(self, parameter, band, dimitri_object='reference', show=True, time='all'):
        """
        Produces plots of the desired parameter over the time series of DimitriObject  TODO, Add ability to subplot with more bands.
        ...
        @param dimitri_object: <string> The object to plot.  Either reference or comparison.  This is becuase the class holds both
